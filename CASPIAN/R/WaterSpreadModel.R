...
WaterSpreadModel <- function(parameters,init_obj,
  ...
  for (nparset in 1:nrow(parameters)){
    ...
    if (incl_biofouling==TRUE) {
      water_netw[,p_biofouling:=f_biofouling(a = parameters[nparset,"a"],c1 = parameters[nparset,"c1"],
                                             g = parameters[nparset,"g"],c2 = parameters[nparset,"c2"],
                                             b = parameters[nparset,"b"],c3 = parameters[nparset,"c3"],
